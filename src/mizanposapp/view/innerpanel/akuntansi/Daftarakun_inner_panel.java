 ...
 * @author Minami
 */
public class Daftarakun_inner_panel extends javax.swing.JPanel {

    /**
     * Creates new form Persedian_inner_panel
     */
    public Daftarakun_inner_panel() {
        initComponents();
        new DaftarakuninnerController(this);
    }
    ...
    private void initComponents() {
        ...
        tabledata = new Tablestyle(0,new int[]{6},new int[]{4});
