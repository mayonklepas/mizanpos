 ...
 * @author Minami
 */
public class DaftarkoreksistokinputController {

    String id;
    CrudHelper ch = new CrudHelper();
    Daftarkoreksistok_input_panel pane;

    public DaftarkoreksistokinputController(Daftarkoreksistok_input_panel pane) {
        this.pane = pane;
        //loaddata(pane);
        //tutup(pane);
        //simpandata(pane);
    ...
    /*private void loaddata(Daftarkoreksistok_input_panel pane) {
        try {
            ...
            Logger.getLogger(DaftarkoreksistokinputController.class.getName()).log(Level.SEVERE, null, ex);
        }

    }*/
 /*private void simpandata(Daftarkoreksistok_input_panel pane) {
 ...
 /*private void tutup(Daftarkoreksistok_input_panel pane) {
